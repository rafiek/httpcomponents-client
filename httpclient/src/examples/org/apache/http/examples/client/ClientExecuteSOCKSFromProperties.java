 ...
 * the configuration of the HttpClient. This means that it is not necessary to create a connection manager when using
 * SOCKS.
 *
 * If either one of the required triggers (SOCKS properties or useSystemProperties) are missing, then the HttpClient
 * just runs with the configured connection manager.
 *
 * @since 4.1
 */
